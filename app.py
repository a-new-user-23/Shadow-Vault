...
with st.sidebar:
    ...
    with st.expander("📖 About This Tool"):
        st.info("""
**Capabilities**
- Hide PDF, ZIP, DOCX, TXT inside PNG pixels
- Max File Size: 10MB
...
if st.session_state.page == "home":
    ...
    with col1:
        ...
        <h3>🔐</h3>
        <h4>Encryption</h4>
        <p>Your file is encrypted before hiding.</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        ...
        <h3>🖼️</h3>
        <h4>Steganography</h4>
        <p>Data hidden inside image pixels invisibly.</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col3:
        ...
        <p>Every vault gets its own key.</p>
        </div>
        """, unsafe_allow_html=True)
